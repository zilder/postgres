...
--
-- test trunc up function!
--
SELECT DATE_TRUNC_UP('MILLENNIUM', TIMESTAMP '1970-03-20 04:30:00.00000', false); -- 2001
SELECT DATE_TRUNC_UP('MILLENNIUM', DATE '1970-03-20', false); -- 2001-01-01
SELECT DATE_TRUNC_UP('CENTURY', TIMESTAMP '1970-03-20 04:30:00.00000', false); -- 2001
SELECT DATE_TRUNC_UP('CENTURY', DATE '1970-03-20', false); -- 2001
SELECT DATE_TRUNC_UP('CENTURY', DATE '2004-08-10', false); -- 2101-01-01
SELECT DATE_TRUNC_UP('CENTURY', DATE '0002-02-04', false); -- 0101-01-01
SELECT DATE_TRUNC_UP('CENTURY', DATE '0055-08-10 BC', false); -- 0001-01-01
SELECT DATE_TRUNC_UP('DECADE', DATE '1993-12-25', false); -- 2000-01-01
SELECT DATE_TRUNC_UP('DECADE', DATE '0004-12-25', false); -- 0010-01-01
SELECT DATE_TRUNC_UP('DECADE', DATE '0002-12-31 BC', false); -- 0001-01-01
SELECT DATE_TRUNC_UP('DECADE', DATE '0012-12-31 BC', false); -- 0011-01-01 BC
SELECT DATE_TRUNC_UP('DECADE', DATE '0010-01-01', true ); -- 0020-01-01
--
-- test infinity
--
